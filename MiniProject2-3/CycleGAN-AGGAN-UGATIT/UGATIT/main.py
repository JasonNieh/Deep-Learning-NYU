...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='/scratch/jz4364/dog2cat', help='dataset_path')
    parser.add_argument('--model_name', type=str, default='Model_Name', help='model_name')
